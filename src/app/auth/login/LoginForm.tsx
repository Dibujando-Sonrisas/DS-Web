...
import { LoaderCircle, Lock, LogIn, Mail, TriangleAlert, UserRound } from "lucide-react";
...
export default function LoginForm() {
  ...
  return (
    <main className={styles.authPage}>
      <div className={`${styles.authCard} card-soft card-drawn`}>
        <div className={styles.authHeader}>
          <div className="icon-circle tone-primary" aria-hidden="true">
            <UserRound />
          </div>
        ...
        <form className={styles.authForm} action={formAction} noValidate>
          ...
          <div className={styles.fieldRow}>
            <label className={styles.checkboxLabel}>
              <input id="remember" name="remember" type="checkbox" disabled={isPending} />
              Recordar sesión
            </label>
